...
void convexHull()
{
	// Find the bottommost point (unutar for petlje)
	ll ymin = points[0].y, min = 0;
	int kolinearne_tacke[25000000]; // tj SIZE/2 jer ne moze biti vise tacaka (kolinearne su barem dvije)
...
#pragma omp for
	for (ll i = 1; i < n; i++)
	{
		...
		// with respect to p0 
		//i++ ne moze pa napravi niz koji ce pamtiti indekse
